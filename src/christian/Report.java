...
public class Report implements ActionListener{
    ...
    int rowno=0;		
		...
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost/inventory1","root","");
...
datee.setBackgroundColor(new BaseColor(159,182,205));   //sets BG color to yellow.
   ...
   */
	 ...
	 Paragraph subtitle= new Paragraph(" PRODUCTS  REPORT",catFont1);
	 subtitle.setAlignment(Element.ALIGN_CENTER);
	 subtitle.setSpacingAfter(50);
        // subtitle.setFont(new Font("rerif",Font.BOLD,24));
...
public void openers(){
	...
	JFileChooser filechooser = new JFileChooser(new File("C:\\Users\\GEORGECAROL\\product report"));
